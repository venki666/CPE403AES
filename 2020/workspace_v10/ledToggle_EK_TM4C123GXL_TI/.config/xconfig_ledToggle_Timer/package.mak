...
override PKGDIR = xconfig_ledToggle_Timer
...
package/%.xdc.inc package/%_xconfig_ledToggle_Timer.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_ledToggle_Timer" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: ledToggle_Timer.pem4f

-include package/cfg/ledToggle_Timer_pem4f.mak
-include package/cfg/ledToggle_Timer_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/ledToggle_Timer_pem4f.dep
endif
ledToggle_Timer.pem4f: package/cfg/ledToggle_Timer_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
ledToggle_Timer.pem4f package/cfg/ledToggle_Timer_pem4f.c: .libraries,em4f
endif

package/cfg/ledToggle_Timer_pem4f.c package/cfg/ledToggle_Timer_pem4f.h package/cfg/ledToggle_Timer_pem4f.xdl: override _PROG_NAME := ledToggle_Timer.xem4f
package/cfg/ledToggle_Timer_pem4f.c: package/cfg/ledToggle_Timer_pem4f.cfg
package/cfg/ledToggle_Timer_pem4f.xdc.inc: package/cfg/ledToggle_Timer_pem4f.xdl
package/cfg/ledToggle_Timer_pem4f.xdl package/cfg/ledToggle_Timer_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/ledToggle_Timer_pem4f.cfg
	-$(RM) package/cfg/ledToggle_Timer_pem4f.dep
	-$(RM) package/cfg/ledToggle_Timer_pem4f.c
	-$(RM) package/cfg/ledToggle_Timer_pem4f.xdc.inc

clean,em4f::
	-$(RM) ledToggle_Timer.pem4f
.executables,em4f .executables: ledToggle_Timer.xem4f

ledToggle_Timer.xem4f: |ledToggle_Timer.pem4f

-include package/cfg/ledToggle_Timer.xem4f.mak
ledToggle_Timer.xem4f: package/cfg/ledToggle_Timer_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/ledToggle_Timer_pem4f.oem4f   package/cfg/ledToggle_Timer_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
ledToggle_Timer.xem4f: export C_DIR=
ledToggle_Timer.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

ledToggle_Timer.test test,em4f test: ledToggle_Timer.xem4f.test

ledToggle_Timer.xem4f.test:: ledToggle_Timer.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 ledToggle_Timer.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.ledToggle_Timer.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,ledToggle_Timer.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) ledToggle_Timer.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
ledToggle_Timer_pem4f.oem4f,copy : package/cfg/ledToggle_Timer_pem4f.oem4f
ledToggle_Timer_pem4f.sem4f,copy : package/cfg/ledToggle_Timer_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_ledToggle_Timer
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_ledToggle_Timer.tar.dep
endif
package/rel/xconfig_ledToggle_Timer/xconfig_ledToggle_Timer/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_ledToggle_Timer/xconfig_ledToggle_Timer/package/package.rel.xml: package/build.cfg
package/rel/xconfig_ledToggle_Timer/xconfig_ledToggle_Timer/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_ledToggle_Timer/xconfig_ledToggle_Timer/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_ledToggle_Timer.tar: package/rel/xconfig_ledToggle_Timer.xdc.inc package/rel/xconfig_ledToggle_Timer/xconfig_ledToggle_Timer/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_ledToggle_Timer.xdc.inc,package/rel/xconfig_ledToggle_Timer.tar.dep)


release release,xconfig_ledToggle_Timer: all xconfig_ledToggle_Timer.tar
clean:: .clean
	-$(RM) xconfig_ledToggle_Timer.tar
	-$(RM) package/rel/xconfig_ledToggle_Timer.xdc.inc
	-$(RM) package/rel/xconfig_ledToggle_Timer.tar.dep
