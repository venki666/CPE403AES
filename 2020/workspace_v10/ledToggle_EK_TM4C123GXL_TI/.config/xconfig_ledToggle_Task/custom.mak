...
linker.cmd: package/cfg/ledToggle_Task_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/ledToggle_Task_pem4fcfg.cmd\)\"$""\"/Users/venkim/workspace_ccs/ledToggle_EK_TM4C123GXL_TI/.config/xconfig_ledToggle_Task/\1\""' package/cfg/ledToggle_Task_pem4f.xdl > $@
