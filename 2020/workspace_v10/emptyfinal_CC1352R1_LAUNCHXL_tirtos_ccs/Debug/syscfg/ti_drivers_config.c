...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* CONFIG_GPIO_LED_B */
    GPIOCC26XX_DIO_03 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH,
};
...
const uint_least8_t CONFIG_GPIO_LED_B_CONST = CONFIG_GPIO_LED_B;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    /* Parent Signal: CONFIG_GPIO_LED_B GPIO Pin, (DIO3) */
    CONFIG_PIN_5 | PIN_GPIO_OUTPUT_EN | PIN_GPIO_HIGH | PIN_PUSHPULL | PIN_DRVSTR_MED,
